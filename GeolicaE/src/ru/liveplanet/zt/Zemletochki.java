...
/**
 * Алгоритм расчета ЗемлеТочек состоит из открытых, публичных и опубликованных  расчетов
 * таких как различные преобразования, приведения в квадрант, вычисление асцендента и МС (середины небы)
 * и из положений и расчетов, составляющих ноу-хау теории землеточек
 * Ноу хау теории землеточек состоит из нулевой точки (ГеоНоль) (поправки к долготе), в данном исходнике это ZTKONST
 * и обязательного преобразования географической (по своей сути экваториальной) широты в новую величину
 * эклиптическую географическую широту. Само преобразование координат - известный научный факт. Нулевая точка -
 * полученная автором уникальна.
 * ГеоНоль (ZTKONST) в различных вариантах в Теории ЗемлеТочек может принимать значение от 15.7 до 16.8 ");
 *  Но наилучшие результаты дает при ZTKONST=16.216666
 * В сумме использование открытых расчетов и нулевой точки создает новый авторский объект
 * © Дмитрий Мирцев, Дамир Башкирцев 1993-2012
 *
 */


public class Zemletochki
{
...
public double degnorm(double x)
{
  ...
  {
      Zemletochki gp =new Zemletochki();
