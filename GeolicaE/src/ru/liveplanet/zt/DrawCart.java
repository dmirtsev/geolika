...
{
    private InsPlArrForKart[] sel;
    String fileName="";

    DrawCart(InsPlArrForKart[] sel,String fileName)
    {
    ...
    public  void start() {
        ...
        try {
            ...
            mapBean.setCenter(new LatLonPoint(43.0f, 45.0f));

            // Set the map's scale 1:120 million
            mapBean.setScale(6000000f);
            ...
            // Add a route layer.
           // DrawRLayer routeLayer = new DrawRLayer(sel);
           // routeLayer.setVisible(true);

            DrawRLayerZJ routeLayerZJ=new DrawRLayerZJ(sel, true);
            routeLayerZJ.setVisible(true);

            DrawRLayerZJ routeLayerZC=new DrawRLayerZJ(sel, false);
            routeLayerZJ.setVisible(true);

            if (!fileName.equals(""))
            {
            DrawTraceHurrigan routeLayerHurr =new DrawTraceHurrigan(fileName);
            routeLayerHurr.setVisible(true);
             mapHandler.add(routeLayerHurr);
            }

         //   TextLayer tl =new TextLayer("Привет");
           // tl.setVisible(true);
           ...
           // mapHandler.add(routeLayer);
            mapHandler.add(routeLayerZJ);
            mapHandler.add(routeLayerZC);
