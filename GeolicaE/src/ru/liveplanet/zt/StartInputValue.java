...
public class StartInputValue
{
    ...
    StartInputValue(int year,int month,int day,double hour,double longi,double lat)
    {
    ...
    static void doHelp(int returnValue)
       {
         ...
         System.err.println("Usage: java StartInputValue [-h][-d][-t][-l][-s][-c][-a][-b]");
        ...
        System.err.println("Пример на дату и координаты 0 планета (Солнце)  и мажорные аспекты");
           System.err.println(" java StartInputValue -d 16.09.1964 -t 6:52 -l 41 -s 69 -a 0 -b majorAspect");
    ...
    public static void main(String[] str) throws Exception
      {
         ...
         // Получение параметров командной строки
          //StartInputValue(int year,int month,int day,double hour,double longi,double lat)
          StartInputValue siv1 = new StartInputValue(Integer.valueOf(strArrDate[2]).intValue(),Integer.valueOf(strArrDate[1]).intValue(),
