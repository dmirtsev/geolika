...
public class ExcelMillionRus
{
    ...
    int typeStrForAnalyzOld=0;   //тип анализируемой строки
     ...
     public ExcelMillionRus( String nameAttachFile) throws Exception
  {
...
//System.out.println("    --- №"+ i +" ---" );
             if   (sheet.getRow(i) !=null ) // или строка информационная а не шапка или что то иное
          {
           ...
           for (int ii = 0; ii < row1.getLastCellNum(); ii++) //цикл перебора ячеек
           {
              ...
              System.out.println("Регион России: " +cap.kodStrani+" " + "Столица: " +cap.capitalName);
...
public static void main(String[] args) throws Exception
  {
    ExcelMillionRus ex=new ExcelMillionRus("xls\\MillionRus.xls");
